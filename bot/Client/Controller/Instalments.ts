...
const apiBaseURL =
  "https://server4.3csistemas.com.br/Homologacao/cobranca/Api/instalments";

const searchInstalments = (cpf: number, offerId: string) => {
  // Monta a url final para requisição
  const url = `${apiBaseURL}/${cpf}/${offerId}`;
